...
vector<Texture> LoadModel::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
{
...
unsigned int LoadModel::TextureFromFile(const char *path, const string &directory)
{
...
Mesh LoadModel::processMesh(aiMesh *mesh,const aiScene *scene){
    ...
    tmpMesh.indcies=indices;
    tmpMesh.verties=vertices;
